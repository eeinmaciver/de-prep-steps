...
def translate_key(student, key_to_change, translation):
    ...
    if key_to_change in new_dict:
        new_dict[translation] = new_dict.pop(key_to_change)
        return new_dict
    else:
        return new_dict
...
def pluralise_keys(dictionary):
    ...
    for dic in dictionary:
        if type(dictionary[dic]) == list:
            new_dict[dic + 's'] = new_dict.pop(dic)
